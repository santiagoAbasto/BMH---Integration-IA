...
input[type="checkbox"]:checked + .custom-checkbox-2 {
    background-color: #0098DA; /* Color cuando está seleccionado */
    color: #fff; /* Color del texto cuando está seleccionado */
    font-weight: bold;
}
          ...
          <div class="col-lg-3" style="padding-top: 31px">
            ...
            <div>
              <select name="categoriaFiltro" id="selectCategoria" class="selectFiltroProducto">
                ...
                @foreach($categoriasAll as $producto)
...
<section style="padding-top: 50px">
  <div class='container miga'>
      <div>
          ...
          </a>  <span style="padding-left:8px; padding-right:8px">/ </span> <a href="{{route('categorias')}}">Productos</a> <span style="padding-left:8px; padding-right:8px"> / </span> @isset($categoria)
      ...
      <section style='padding-bottom:70px; padding-top: 60px'>
        <div class='container'>
            <div class='row'>
                <div class='categoriaI col-lg-3 mb-5'>
    ...
    function enviar(){
        $.ajax({
            ...
            data: {
                ...
                min:price_range_values[0],
                max:price_range_values[1],
                tipo:'destacados'
            },
...
var marcas = @json($marcas); // Obtener las marcas desde PHP
