...
<form method="GET" action="{{ route('filtroRodamientos') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 d-flex justify-content-start align-items-center recons">
                            <div class="checkbox-container">
                    ...
                    <div class="row">
                        <div class="col-lg-3" style="padding-top: 31px">
                            <div class="d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 60 39"
                                    fill="none">
                                    <path
                                        d="M7.99135 19.6078V37.3813C7.99135 38.627 7.6082 38.9849 6.31232 38.9837H1.50842C0.463283 38.9837 0.0086702 38.5308 0.00749851 37.4832C0.00124954 34.4073 -0.00109354 31.3318 0.000468703 28.2567C0.000468703 19.4829 0.000468703 10.7098 0.000468703 1.93749C0.000468703 0.619258 0.380098 0.246669 1.72519 0.247801C3.30696 0.247801 4.88795 0.247801 6.46816 0.247801C7.57657 0.247801 7.99135 0.6555 7.99135 1.78007C7.99135 7.72191 7.99135 13.6645 7.99135 19.6078Z"
                                        fill="#0098DA" />
                                    <path
                                        d="M59.9918 19.5988C59.9918 25.5036 59.9813 31.4096 60 37.3144C60 38.3495 59.6157 39.0585 58.2425 38.9962C56.6267 38.9237 55.0039 38.9826 53.3835 38.9815C52.5188 38.9815 52.0466 38.5409 52.0091 37.7108C52.0033 37.5602 52.0033 37.4084 52.0033 37.2578C52.0033 25.4663 52.008 13.6739 52.0173 1.88086C52.0173 1.47543 52.1146 0.998646 52.3513 0.684944C52.5387 0.435795 53.0062 0.27385 53.3554 0.265922C55.0907 0.222887 56.8283 0.239872 58.5659 0.245535C59.4962 0.245535 59.9883 0.733643 59.9906 1.65663C59.9965 4.10849 59.9906 6.56148 59.9906 9.01786V19.6022L59.9918 19.5988Z"
                                        fill="#0098DA" />
                                    <path
                                        d="M26.9726 14.37C26.9726 10.2387 26.9832 6.10281 26.9656 1.97599C26.9656 0.784603 27.4343 0.163996 28.7231 0.236476C29.6604 0.293101 30.5978 0.243272 31.5351 0.247802C32.4526 0.247802 32.8966 0.630586 33.0079 1.50034C33.0185 1.63183 33.0208 1.76382 33.015 1.89558C33.015 10.2345 33.015 18.5731 33.015 26.9113C33.015 27.4277 32.9927 27.96 32.5053 28.276C32.2302 28.4449 31.9135 28.5399 31.5879 28.5512C30.5732 28.5851 29.5585 28.5648 28.5415 28.5648C27.4682 28.5648 26.9808 28.1038 26.975 27.0472C26.9656 25.2556 26.975 23.4629 26.975 21.6713L26.9726 14.37Z"
                                        fill="#0098DA" />
                                    <path
                                        d="M11.0108 14.387C11.0108 10.1975 11.0108 6.0073 11.0108 1.81631C11.0108 0.609067 11.4021 0.238741 12.6593 0.238741C13.6541 0.238741 14.6512 0.233078 15.646 0.238741C16.4743 0.245536 16.9875 0.739305 16.9887 1.54791C16.9887 10.096 16.9887 18.6441 16.9887 27.1922C16.9887 28.0755 16.4872 28.5512 15.5733 28.5512C14.5383 28.5557 13.5037 28.5557 12.4695 28.5512C11.5123 28.5512 11.0178 28.0835 11.0178 27.1729C11.0178 22.9079 11.0178 18.6422 11.0178 14.3757L11.0108 14.387Z"
                                        fill="#0098DA" />
                                    <path
                                        d="M48.978 14.3904C48.978 18.6547 48.978 22.9185 48.978 27.182C48.978 28.088 48.4824 28.5557 47.5251 28.5591C46.5678 28.5625 45.5742 28.5591 44.5959 28.5591C43.4242 28.5534 43.0024 28.1446 43.0024 27.0291C43.0024 20.3678 43.0024 13.7068 43.0024 7.04618C43.0024 5.27269 43.0024 3.49845 43.0024 1.72344C43.0024 0.68268 43.4617 0.239874 44.5256 0.241006C45.5403 0.241006 46.5561 0.241006 47.572 0.241006C48.5093 0.241006 48.978 0.694005 48.978 1.6C48.978 5.86348 48.978 10.1292 48.978 14.3972V14.3904Z"
                                        fill="#0098DA" />
                                    <path
                                        d="M24.9866 14.3972C24.9866 17.2247 24.9866 20.0529 24.9866 22.8819C24.9866 24.3145 24.9866 25.7471 24.9737 27.1797C24.9667 28.1197 24.505 28.5591 23.5361 28.5614C22.5214 28.5614 21.5067 28.5614 20.4897 28.5614C19.5066 28.5614 18.9864 28.0846 18.9852 27.1537C18.9806 18.6479 18.9806 10.1409 18.9852 1.63285C18.9852 0.726848 19.509 0.248935 20.4358 0.24667C21.4704 0.24667 22.505 0.238743 23.5384 0.24667C24.4968 0.252333 24.9761 0.687211 24.9866 1.61586C25.003 3.04847 24.9866 4.48221 24.9866 5.91935C24.9866 8.74757 24.9866 11.5758 24.9866 14.404V14.3972Z"
                                        fill="#0098DA" />
                                    <path
                                        d="M35.0127 14.4233C35.0127 11.5958 35.0127 8.76796 35.0127 5.93973C35.0127 4.50599 34.9916 3.07338 35.0057 1.63624C35.015 0.669089 35.4849 0.242138 36.4843 0.23874C37.5185 0.23874 38.5527 0.23874 39.5869 0.23874C40.4388 0.23874 40.9192 0.666826 41.007 1.49015C41.0223 1.63851 41.007 1.7914 41.007 1.94315C41.007 10.2421 41.007 18.541 41.007 26.84C41.007 28.1491 40.5899 28.5557 39.2331 28.5591C38.277 28.5591 37.3209 28.5591 36.3648 28.5591C35.5446 28.5534 35.0256 28.0914 35.0232 27.3202C35.0104 24.1344 35.0139 20.9476 35.0115 17.7619C35.0123 16.649 35.0127 15.5361 35.0127 14.4233Z"
                                        fill="#0098DA" />
                                </svg>
                                <p class="textCodigo">
                                    Por cód. BMH
                            ...
                            <div>
                                <input type="text" name="codigoBMH" class="inputFiltroCodigo"
                        ...
                        <div class="col-lg-3" style="padding-top: 31px">
                            ...
                            <div>
                                <input type="text" name="equivalenciaFiltro" class="inputFiltroCodigo"
                                    placeholder="Ingresar código">
                            </div>
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 d-flex justify-content-center gap-3">
                            <button type="submit" class="btn boton-filtro">Buscar</button>
                            <button type="button" id="limpiarFiltros" class="btn boton-filtro">Limpiar</button>
                        </div>
        ...
        <div class="container">
            ...
            <div class='row'>
                @foreach ($categorias as $categoria)
                    <div class="col-12 col-sm-6 col-lg-3 mb-4" data-aos="fade-up">
