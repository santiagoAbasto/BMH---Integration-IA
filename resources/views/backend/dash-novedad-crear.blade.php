...
@section('content')
<h1 class='mb-4'>Crear novedad</h1>
  @if(session('success'))
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class='pb-3' id='actualizar' action="{{route('novedad.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class='row'>
                <div class="mb-3 col-9">
                    ...
                    <input type="text" class="form-control" name='epigrafe' required>
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="summernote" class='summernote-producto' name="texto"></textarea>
            </div>
            ...
            <div class=" mb-3 form-check">
                <input class="form-check-input" type="checkbox" checked id="flexCheckDefault" name='destacada'>
                <label class="form-check-label" for="destacada">
                    Destacada
                </label>
            </div>

            <button  data-form-id="actualizar" type="submit" class="btn btn-primary submit" style='float:right;'>Agregar</button>
